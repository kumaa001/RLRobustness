...
while(count <= stepCount)
   ...
   JG5 = computeIHCostGrad(A,Bui,Bw,C,Dui,Q,R,W,V,p,5,S,Mcl,Acl);
   JG6 = computeIHCostGrad(A,Bui,Bw,C,Dui,Q,R,W,V,p,6,S,Mcl,Acl);
   ...
   % Gradient vector
   JG = [JG1;JG2;JG3;JG4;JG5;JG6];
   p = p - eta.*JG;
   
   % Controller with the new given parameter
   [Ak,Bk,Ck] = Kcontrollable3(p);
